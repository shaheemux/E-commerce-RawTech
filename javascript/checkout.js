...
let computer6 = new Computer(6, " CORSAIR","Performance Plus Core I5 4060Ti Gaming PC","R6,499", "https://i.postimg.cc/grbdk7jx/SY-PCBuild-Pink-Odyssey-Airflow-removebg-preview-1.png");
...
let mainContent = document.querySelector('checkout')
...
function admin() {
    ...
    output.innerHTML = products.join(' ')
}
